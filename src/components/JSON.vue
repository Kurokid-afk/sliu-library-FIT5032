<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      <h2>
        Attribute, Class and Style Binding with <code>v-bind</code>
      </h2>
      ...
      <ul>
        <li
          ...
          :style="{
            fontWeight:
              author.name === 'George Orwell' ? 'bold' : 'normal',
            color:
              author.name === 'George Orwell' ? 'white' : '#333'
          }"
        >
          {{ author.name }} — {{ author.birthYear }}
        </li>
